...
class HomeFragment : Fragment() {
    ...
    fun onCardClick(clickedCardId: Int, category: String) {
        // Replace the current fragment with CameraFragment and pass the clickedCardId
        val fragment = CameraFragment().apply {
            arguments = Bundle().apply {
                putInt(ARG_IMAGE_ID, clickedCardId)
